<template>
  <div class="grid">
    <div class="row">
      <div class="col c-12 m-8 m-o-2 l-6 l-o-3 logup">
        <div class="logup-form">
          <div class="logup-form__logo">
          ...
          <h2 class="logup-form__title">Tạo tài khoản với Google</h2>
          <h3 class="logup-form__des">Tiếp tục với YouTube</h3>
          <ValidationObserver ref="form" v-slot="{ handleSubmit, reset }">
            <form @submit.prevent="handleSubmit()" @reset.prevent="reset">
              <div class="logup-form__divide">
                <ValidationProvider
                  v-slot="{ errors }"
                  name="FamilyName"
                  rules="required"
                >
                  <input
                    ...
                    class="form-control"
                  />
                  <span class="errors-text">{{ errors[0] }}</span>
                </ValidationProvider>
                <ValidationProvider
                  v-slot="{ errors }"
                  name="Name"
              ...
              <div class="logup-form__divide">
                ...
                <div>
                  <input
                    ...
                    class="form-control"
                  />
                  <span class="errors-text">{{ validatePassword }}</span>
                </div>
              </div>
              ...
              <div class="login-form__btn">
                ...
                <button
                  type="submit"
                  class="login-form__login btn btn--success"
                  @click="onSubmit"
                >
                  Tạo
                </button>
        ...
        <div class="logup-logo">
          <img
            class="logup-logo__img"
            src="https://cdn.chanhtuoi.com/uploads/2020/05/w400/icon-facebook-16-1.jpg.webp"
            alt="smile relax"
          />
          <div class="logup-logo__description">
  ...
  methods: {
    ...
    onSubmit() {
      if (this.password == this.checkPassword) {
        ...
        this.validatePassword = "Mật khẩu không giống nhau!";
      }
    },
