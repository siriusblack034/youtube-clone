  ...
  <header class="header">
    ...
    <div class="header__center">
      <div class="header__search">
        ...
        <router-link
          tag="button"
          class="header__search-form-btn btn"
          :to="{
            name: 'Result',
            query: {
              search_query: search(),
      ...
      <div class="header__search-voice">
    ...
    <div class="header-right">
      ...
      <div class="header-right__setting">
      ...
      <router-link
        tag="button"
        class="header-right__log-in btn btn-primary"
        to="/login"
      >
...
.header-right__log-in:focus {
  background: rgba(0, 0, 0, 0.2);
}

.header-right__log-in i {
  opacity: 1;
  margin-right: 4px;
  font-size: 2rem;
}
