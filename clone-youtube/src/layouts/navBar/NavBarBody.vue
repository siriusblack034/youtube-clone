      ...
      <div class="header__logo">
        <a href="" class="header__logo-link">
          <div class="style-scope ytd-topbar-logo-renderer">
            <div id="logo-icon" class="style-scope ytd-topbar-logo-renderer">
              <svg
                viewBox="0 0 200 60"
    ...
    <div class="scrollbar" id="style-2">
      <div class="force-overflow">
        <ul class="body-top__list">
          <router-link tag="li" class="body-top__item" to="/">
            <i class="fas fa-home"></i>
            Trang chủ
          </router-link>

          <router-link tag="li" class="body-top__item" to="/trending">
            <i class="fas fa-fire"></i>
            Thịnh Hành
          </router-link>

          <router-link tag="li" class="body-top__item" to="/ChannelRegister">
        ...
        <ul class="body-top__list">
          ...
          <router-link
            ...
            :key="channel.nameChannel"
          >
            <img :src="channel.imgChannel" alt="imgChannel" />
            {{ channel.nameChannel }}
          </router-link>
        </ul>
...
<script>
export default {
  props: ["styles", "viewpoint"],
  data() {
    return {
      channels: [
        {
          imgChannel:
            "https://yt3.ggpht.com/ytc/AAUvwnjpIycTWzhhQL2Nr7Myqh012N-Q6QdqUeQOgICE8w=s88-c-k-c0x00ffffff-no-rj",
          nameChannel: "ChillsCow",
        },
        {
          imgChannel:
            "https://yt3.ggpht.com/ytc/AAUvwniqkVXvK9dEpAu9Mkpyz46oCwFYOgg5ummDXx0c=s88-c-k-c0x00ffffff-no-rj",
          nameChannel: "JohnTech",
        },
        {
          imgChannel:
            "https://yt3.ggpht.com/ytc/AAUvwngq6mRJPaSGZI4cFyXnaETwvJwXOlARO31HBZtuVw=s88-c-k-c0x00ffffff-no-rj",
          nameChannel: "VTCNOW",
        },
        {
          imgChannel:
            "https://yt3.ggpht.com/ytc/AAUvwnjDqSi1gYq6DejpqxoV07coJgzc7l6QbQMCMb_r=s88-c-k-c0x00ffffff-no-rj",
          nameChannel: "Độ Mixi",
        },
        {
          imgChannel:
            "https://yt3.ggpht.com/ytc/AAUvwni9b1f0B7V_Wy4UGanrNSzfdzjFAhqNlJgJUqeIaQ=s88-c-k-c0x00ffffff-no-rj",
          nameChannel: "Phê Phim",
        },
        {
          imgChannel:
            "https://yt3.ggpht.com/ytc/AAUvwniQnTuwvh9KHijwxxEo8Ts26jQxG-tUDGFD1Qzo=s88-c-k-c0x00ffffff-no-rj",
          nameChannel: "Xế Tuyển",
        },
      ],
    };
  },
